...
class SnippetsControllerTest < ActionController::TestCase
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post :create, snippet: { highlighted_code: @snippet.highlighted_code, language: @snippet.language, name: @snippet.name, plain_code: @snippet.plain_code }
    end
  ...
  test "should update snippet" do
    put :update, id: @snippet, snippet: { highlighted_code: @snippet.highlighted_code, language: @snippet.language, name: @snippet.name, plain_code: @snippet.plain_code }
    assert_redirected_to snippet_path(assigns(:snippet))
  end
